...
class Menu:
    ...
    def run(self):
        ...
        while True:
            ...
            self.menu_text(50, "Guerra nas", COLOR_ORANGE, ((WIN_WIDTH / 2), 70))
            self.menu_text(50, "Montanhas", (255, 128, 0), ((WIN_WIDTH / 2), 120))
                ...
                if event.type == pygame.KEYDOWN:  # Testar se alguma tecla foi pressionada
                    if event.key == pygame.K_DOWN:  # Testar se a tecla para baixo foi pressionada
                        if menu_option < len(MENU_OPTION) - 1:
                            ...
                            menu_option = 0
                    if event.key == pygame.K_UP:  # Testar se a tecla para baixo foi pressionada
                        if menu_option > 0:
                            menu_option -= 1
                        else:
